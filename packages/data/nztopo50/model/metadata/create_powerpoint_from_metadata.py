...
def add_summary_slide(prs, summary_info):
    ...
    if title_shape:
        ...
        slide.shapes.add_textbox(
            Inches(0.5), Inches(0.2), Inches(6), Inches(0.5)
        ).text = f"{category} Layers and Themes"
...
def add_feature_slide(
    ...
    if title_shape:
        ...
        slide.shapes.add_textbox(
            Inches(0.5), Inches(0.2), Inches(6), Inches(0.5)
        ).text = f"Feature Type: {feature_type}"
...
if __name__ == "__main__":
    ...
    for table_key, table_val in metadata.items():
        ...
        feature_names = (
            table_val["feature_types"] if "feature_types" in table_val else []
        )
        ...
        if "features" in table_val:
            for feature_name, feature_info in table_val["features"].items():
                ...
                add_feature_slide(
                    ...
                    description,
                    feature_picture_path,
                    aerial_picture_path=aerial_picture_path,
                )
