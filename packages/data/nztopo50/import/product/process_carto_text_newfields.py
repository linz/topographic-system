...
class CartoTextProcessor:
        ...
        try:
            ...
            for _index, row in df.iterrows():
                ...
                if row_value.startswith("ATT"):
                    ...
                    if current_section:
                        att_sections.append({"att_name": current_att_name, "data": current_section})
    ...
    def process_symbol_text_to_queries(self, full_layers_df, gdf):
        ...
        for _index, row in full_layers_df.iterrows():
        ...
        for query_idx, query_data in enumerate(processed_queries):
            ...
            for text_bend_value, group in text_bend_groups:
                ...
                if matching_new_values.empty:
                    ...
                    value_setting_info = f"text_bend_value = {text_bend_value}"
                ...
                if matching_new_values.empty:
                    ...
                    value_setting_info = f"text_bend_value = {text_bend_value}, text_height = {text_height}"
                ...
                if placement_value.startswith("(") and placement_value.endswith(")"):
                    ...
                    placement_value = (
                        placement_value.split("==")[1].strip() if "==" in placement_value else placement_value
                    )
                ...
                value_setting_info = (
                    "font_symbol = {0}, text_bend = {1}, text_height = {2}, colour = {3}, text placement = {4}".format(
                        query_data["conditions"].get("text_font", None),
                        text_bend_value,
                        text_height,
                        text_colour_number,
    ...
    def run(self):
        ...
        full_layers_csv = self.process_fulllayers_tab(self.mapping_spreadsheet, self.full_layers_sheet)
        if full_layers_csv:
        ...
        new_values_csv = self.process_new_values_tab(self.mapping_spreadsheet, self.new_values_sheet)
        if new_values_csv:
        ...
        font_mapping_csv = self.process_font_mapping_tab(self.mapping_spreadsheet, self.font_mapping_sheet)
        if font_mapping_csv:
