...
islands_out = rf"C:\Data\Topo50\{schema_name}_NZ50_Shape\island_poly.shp"
sea_poly = rf"C:\Data\Topo50\{schema_name}_NZ50_Shape\sea_coastline.shp"
...
sea_gdf = sea_gdf.to_crs(epsg=2193)
