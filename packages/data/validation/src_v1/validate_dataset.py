...
class TopologyValidator:
    def __init__(self, db_url, table, export_layername, table2=None,  
        ...
        if db_url.startswith('postgresql'):
            ...
            raise ValueError("db_url must be a PostgreSQL connection string, a GeoPackage file path, or a Parquet file path.")
    ...
    def run_multipart_geometry_checks(self):
        ...
        self.save_gdf(multipart_geometries, validation_type='multipart geometries', extended_name='geometry')
        print("Time taken for process multipart geometry check:", datetime.datetime.now() - starttime)
