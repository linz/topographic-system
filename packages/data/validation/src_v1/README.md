...
run_validation.py - apply the seeting and run. Can be convert into a command line option.
validate_dataset_controller.py - create a correct validator process based on data types, sets up and run validation. Called from run_validation.
topology_validation_tools.py - Settings Class and some utilities.
...
Settings
    ...
    db_url = "postgresql://postgres:<password>@localhost:5432/topo"
