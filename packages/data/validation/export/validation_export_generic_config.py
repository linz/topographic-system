...
def options_layer_generic():
    ...
    line_not_on_feature_layers = [
        {
            "line_table": "bridge_line",
            "intersection_table": "road_line",
    ...
    line_not_touches_feature_layers = [
        {
            "line_table": "ferry_crossing",
            "intersection_table": "structure_line",
    ...
    return (feature_not_on_layers, feature_in_layers, line_not_on_feature_layers, line_not_touches_feature_layers, feature_not_contains_layers, self_intersection_layers, null_columns, query_rules)

feature_not_on_layers, feature_in_layers, line_not_on_feature_layers, line_not_touches_feature_layers, feature_not_contains_layers, self_intersect_layers, null_columns, query_rules = options_layer_generic()
data = {
...
with open('./validation/system/validation_generic_config.json', 'w') as f:
    json.dump(data, f, indent=4)

with open('./validation/system/validation_generic_config.json', 'r') as f:
