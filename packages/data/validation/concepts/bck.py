...
all_intersection_geometries = intersection_geometries + intersection_geometries_point + intersection_geometries_line
...
intersections_gdf.to_file(r"c:\temp\topology_checks.gpkg", layer="topology_errors_areas", driver="GPKG")
...
#intersections_gdf = intersections_gdf.to_crs(epsg=2193)
intersections_gdf.to_file(r"c:\temp\topology_checks.gpkg", layer="topology_errors_points", driver="GPKG")
...
#intersections_gdf = intersections_gdf.to_crs(epsg=2193)
intersections_gdf.to_file(r"c:\temp\topology_checks.gpkg", layer="topology_errors_lines", driver="GPKG")
