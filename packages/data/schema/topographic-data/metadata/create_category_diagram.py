...
def create_main_and_layer_diagrams(metadata_file_path, output_folder):
    ...
    category_colors = {
        "Transport and Infrastructure": "powderblue",
        "Buildings & Structures": "powderblue",
        "Land Cover & Land Use": "powderblue",
        "Water Marine Coastal Hydrographic": "powderblue",
        "Terrain": "powderblue",
        "Administrative & Reference": "powderblue",
    }
...
if __name__ == "__main__":
    ...
    metadata_file = os.path.join(metadata_source_folder, "metadata_info.json")
